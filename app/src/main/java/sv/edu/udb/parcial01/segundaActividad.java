            ...
            public void onClick(View v) {
                ...
                * no abrira la camara automaticamente sin permisos*/
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
                    ...
                    if (ActivityCompat.checkSelfPermission(segundaActividad.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_GRANTED){

                        abrirCamara();
                    }
                    /*Habilitamos los permisos pidiendole al usuario que brinde el permiso*/
                    else{
                        ActivityCompat.requestPermissions(segundaActividad.this,new String[]{Manifest.permission.CAMERA},REQUEST_PERMISSION_CAMERA);
                    }
                }
                else{
                    abrirCamara();
